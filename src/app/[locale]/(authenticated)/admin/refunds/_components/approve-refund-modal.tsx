...
export function ApproveRefundModal({
  ...
  const t = useTranslations("admin.refunds.approveModal");
      ...
      >
        ...
        <form action={onSubmit}>
          ...
          <div className="flex items-center justify-end gap-3 border-t border-surface-container-high px-8 py-5">
            ...
            <button
              className="flex h-10 items-center gap-2 rounded-xl bg-emerald-600 px-5 text-sm font-bold text-white transition-opacity hover:opacity-90 disabled:opacity-60"
              disabled={isPending}
              type="submit"
            >
